...
export interface EditorialContextValue extends RenderCore {
...
export const EditorialContext = React.createContext<EditorialContextValue | null>(null);
let count = 1;
