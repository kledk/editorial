...
export function ListsAddon(props) {
    usePlugin({
        normalizeNode: (normalizeNode, editor) => ([node, path]) => {
            if (Element.isElement(node) && node.type === TYPE_LIST_ITEM) {
                ...
                if (parent &&
                    ...
                    ![TYPE_ORDERED_LIST, TYPE_UNORDERED_LIST].includes(parent.type)) {
                ...
                for (const [child, childPath] of Node.children(editor, path)) {
                    ...
                    if (Element.isElement(child)) {
                        if (child.type !== TYPE_LIST_ITEM) {
                            Transforms.setNodes(editor, { type: TYPE_LIST_ITEM, children: [{ text: "" }] }, { at: childPath });
                            return;
                        }
                        else {
                            if (!child.children) {
    ...
    useRenderElement(_renderElement);
    useOnKeyDown({
        pattern: "enter",
        handler: (e, editor) => {
            ...
            if (!ancestor ||
                (Element.isElement(ancestor) &&
                    ![TYPE_ORDERED_LIST, TYPE_UNORDERED_LIST].includes(ancestor.type))) {
                return false;
            }
            e.preventDefault();
            if (!isElementEmpty(editor)) {
                ...
                const list = getAncestor(editor, active, 1);
    ...
    useOnKeyDown({
        ...
        handler: (e, editor) => {
            ...
            if (ancestor.children.length > 1) {
                e.preventDefault();
                const index = (ancestor === null || ancestor === void 0 ? void 0 : ancestor.children.indexOf(element)) - 1;
                if (ancestor.children[index].type !== TYPE_LIST_ITEM) {
                    ...
                    const destination = ReactEditor.findPath(editor, otherList.children[otherList.children.length - 1]);
    ...
    useOnKeyDown({
        ...
        handler: (e, editor) => {
            ...
            if (e.shiftKey) {
                ...
                if (ancestor === null || ancestor === void 0 ? void 0 : ancestor.children.find((child) => child.type === TYPE_LIST_ITEM)) {
                    ...
                    if ((element === null || element === void 0 ? void 0 : element.children.length) == 1) {
